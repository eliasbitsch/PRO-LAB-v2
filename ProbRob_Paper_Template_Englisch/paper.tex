...
EKF    & $(x,y,\theta)$ & $(v,\omega)$ \texttt{/odom}     & range--bearing, IMU \\ \hline
EKF-LF & $(x,y,\theta)$ & $(v,\omega)$ \texttt{/cmd\_vel} & scan likelihood field \\ \hline
PF     & $\{(x,y,\theta)^{[k]}\}$ & $(v,\omega)$ \texttt{/cmd\_vel} & scan likelihood field \\ \hline
AMCL   & $\{(x,y,\theta)^{[k]}\}$ & \texttt{/odom} (TF) & scan (beam model) \\ \hline
\end{tabular}}
